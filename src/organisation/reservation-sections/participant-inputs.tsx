    ...
    return (
        <section className={styles.sectionCard}>
            <div className={styles.sectionHeading}>
                <PageTitle
                    title={t("organisation-public.reservation.participants-title")}
                    isSubTitle
            ...
            <div className={styles.teilnehmerFields}>
                <div className={styles.fieldGroup}>
                    <FieldLabel htmlFor="public-anlass-male">{t("organisation-public.reservation.participants-fields.male")}</FieldLabel>
                    <DetailsNumberInput
                        id="public-anlass-male"
                        value={maleCount}
                        onChange={(e) => onMaleCountChange(e.target.value)}
                        slotProps={{
                            htmlInput: {inputMode: "numeric", "aria-label": t("organisation-public.reservation.participants-fields.male")},
                        }}
                    />
                </div>
                <div className={styles.fieldGroup}>
                    <FieldLabel htmlFor="public-anlass-female">{t("organisation-public.reservation.participants-fields.female")}</FieldLabel>
                    <DetailsNumberInput
                        id="public-anlass-female"
                        value={femaleCount}
                        onChange={(e) => onFemaleCountChange(e.target.value)}
                        slotProps={{
                            htmlInput: {inputMode: "numeric", "aria-label": t("organisation-public.reservation.participants-fields.female")},
                        }}
                    />
                </div>
                <div className={styles.fieldGroup}>
                    <FieldLabel htmlFor="public-anlass-under20">{t("organisation-public.reservation.participants-fields.under-20")}</FieldLabel>
                    <DetailsNumberInput
                        id="public-anlass-under20"
                        value={under20Count}
                        onChange={(e) => onUnder20CountChange(e.target.value)}
                        slotProps={{
                            htmlInput: {inputMode: "numeric", "aria-label": t("organisation-public.reservation.participants-fields.under-20")},
                        }}
                    />
                </div>
                <div className={styles.fieldGroup}>
                    <FieldLabel htmlFor="public-anlass-total">
                        {t("organisation-public.reservation.participants-fields.total-persons")}
                    </FieldLabel>
                    <DetailsNumberInput
                        readOnly
                        ...
                        slotProps={{
                            htmlInput: {
                                inputMode: "numeric",
                                "aria-label": t("organisation-public.reservation.participants-fields.total-persons"),
                            },
                        }}
                    />
                </div>
